...
use MainApp\Application\Actions\Auth\LoginAction;
use MainApp\Application\Actions\Auth\PostDeleteAccountAction;
use MainApp\Application\Actions\Auth\PostLoginAction;
use MainApp\Application\Actions\Auth\PostLogoutAction;
use MainApp\Application\Actions\Auth\PostRegisterAction;
use MainApp\Application\Actions\Auth\RegisterAction;
use MainApp\Application\Actions\Auth\ValidateAction;
...
use MainApp\Application\Controllers\EmailController;
...
// IMAP Search Routes
	...
	$app->group('/api/imap-accounts', function (Group $group){
		$group->get('/list', function (Request $request, Response $response) {
 			$db = new DbController();
